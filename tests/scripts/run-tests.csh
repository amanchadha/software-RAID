...
set resultDir = /u/c/s/cs537-2/tests/p2/results
set scriptDir = /u/c/s/cs537-2/tests/p2/scripts

set weights = ( 17 17 17 17 17 15 ) #6 6 6 6 6 12.5 12.5 12.5 12.5 10 )
if ($#argv == 1) then
    set list = $argv
else
